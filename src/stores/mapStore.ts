...
for (const garageName of Object.values(ParkingGarageNames)) {
    loadParkingGaragesData(garageName).then((data) => {
        switch (garageName) {
            case ParkingGarageNames.Bleiche:
                bleiche.value = data;
                break;
            case ParkingGarageNames.Cinestar:
                cinestar.value = data;
                break;
            case ParkingGarageNames.CityPort:
                cityPort.value = data;
                break;
            case ParkingGarageNames.Deutschhausplatz:
                deutschhausplatz.value = data;
                break;
            case ParkingGarageNames.Loehrstrasse:
                loehrstrasse.value = data;
                break;
            case ParkingGarageNames.Rheinufergarage:
                rheinufergarage.value = data;
                break;
            case ParkingGarageNames.RoemischesTheater:
                roemischesTheater.value = data;
                break;
            case ParkingGarageNames.Schillerplatz:
                schillerplatz.value = data;
                break;
            case ParkingGarageNames.Taubertsberg:
                taubertsberg.value = data;
                break;
            case ParkingGarageNames.Augustusplatz:
                augustusplatz.value = data;
                break;
            default:
