<template>
    ...
    >
        <template v-slot:activator="{ props: menuProps }">
            <v-tooltip v-bind="menuProps" text="Filter Options" location="bottom">
        ...
        <v-card class="pa-3 card" rounded="lg" elevation="1">
            <div class="d-flex flex-column card-elements">
                ...
                >
                    <template #selection="{ item, index }">
                        ...
                        >
                            (+{{ unsavedFilter.parkingGarages.length - 2 }} more)
                        </span>
                    </template>
                    ...
                    >
                        <template v-slot:activator="{ props }">
                            <v-text-field
                                ...
                                flat
                                readonly
                                class="cursor-pointer hover-pointer"
                            />
                        </template>
                ...
                <v-slider
                    ...
                    density="compact"
                    hide-details
                    label="Prediction quality threshold"
                />
